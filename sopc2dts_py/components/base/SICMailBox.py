...
"""Port of sopc2dts.lib.components.base.SICMailBox."""
...
class SICMailBox(BasicComponent):
    """
    Mailbox component — adds a linux,mailbox-name property.
    Port of sopc2dts.lib.components.base.SICMailBox.
    """
    ...
    def to_dt_node(self, board_info: object, conn: Optional["Connection"]) -> object:
        ...
        node.add_property(DTProperty("linux,mailbox-name", self.instance_name))
        return node
